                    ...
                    <div style="padding:20px;"class="panel panel-default">
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="initial_budget" id="initial_budget" placeholder="100"  >
								
                            </div>
                            <div class="form-group">
                            <label class="col-xs-offset-4" for="people">No. of People</label>
                            <input type="number" class="form-control col-xs-offset-4" name="people" id="people" placeholder="2 "  >
                        </div>
                        </div><br>
                         <div class="form-group">
