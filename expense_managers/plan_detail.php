                ...
                <div class="col-xs-8">
                    <div style="padding:20px;"class="panel panel-default">
                        ...
                        <div class="form-inline">
                            ...
                            <input type="date" class="form-control" name="from_date" id="from_date" placeholder="dd/mm/yyyy" required="true" min="2019-04-01">
                            </div>
                            <div class="form-group">
                            <label class="col-xs-offset-8" for="to_date">To</label>
                            <input type="date" class="form-control col-xs-offset-8" name="to_date" id="to_date" placeholder="dd/mm/yyyy" required="true" max="2050-04-20">
                        </div>
                        </div><br>
                        <div class="form-inline">
                            <div class="form-group">
                                <label for="initial budget">Initial Budget</label><br>
                                <input type="number" class="form-control" name="initial budget" id="initial budget" placeholder="10000" disabled>
                            </div>
                            <div class="form-group">
                            <label class="col-xs-offset-4" for="no. of people">No. of People</label>
                            <input type="number" class="form-control col-xs-offset-4" name="no. of people" id="no. of people" placeholder="2" disabled>
                        </div>
                        </div><br>
                         <div class="form-group">
