                      ...
                      <h1>Create New Plan</h1>
                          ...
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control" name="how many people you want to add in your group?"
							   ...
							   <button type="submit" style="background-color:white" class="btn btn-primary btn-lg btn-block" name="next"value="next"> <a href="plan_details.php" style="color:#2E8B57; text-decoration: none;">Next</a></button>
