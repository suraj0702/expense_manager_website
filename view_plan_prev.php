<?php
session_start();
$con = mysqli_connect("localhost", "root", "", "expensemanager")or die($mysqli_error($con));
$select_query = "SELECT  initial_budget,people,from_date,to_date FROM plan_detail";
                ...
                <div class="col-xs-7">
                    <div class="panel panel-default">
                        <div style="color: white; text-align: center; height: 100px; background-color: #2E8B57;" class="panel-heading">
                            <h2>My first Plan</h2>
                            <h4><div style="float:right;" ><span class="glyphicon glyphicon-user"></span> <?php echo $row['people'];  ?></div></h4>
                        </div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding-left: 410px; padding-bottom: 20px;">&#8377 <?php echo $row['initial_budget'];  ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><b>Date</b></td>
                                        <td style="padding-left: 280px;"><?php echo $row['from_date'];echo " to ";echo $row['to_date']; ?>
										</td>
                                    </tr>
                                </tbody>
                            </table>
