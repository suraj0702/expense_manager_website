                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 450px; padding-bottom: 20px;">
                                        <b>  &#8377 <?php echo $_SESSION['rmn_amt']-$_SESSION['amount_spent']-$_SESSION['amount_spent2'];?></b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><b>Date</b></td>
                                        <td style="padding-left: 290px;"><?php echo $_SESSION['to_date']; echo"-"; echo $_SESSION['from_date'];?></td>
                                    </tr>
                                </tbody>
                            </table>
                            </div>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 180px; padding-bottom: 20px;"><?php echo $_SESSION['person_1'];?></td>
                                    </tr>
                                    <tr>
                                        <td><b>Paid On</b></td>
                           ...
                           <div class="panel-body">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="padding-bottom: 20px;"><b>Amount</b></td>
                                        <td style="padding-left: 180px; padding-bottom: 20px;">Rs.<?php echo $_SESSION['amount_spent2'];?>
										</td>
                                    </tr>
                                    <tr>
                                        <td style="padding-bottom: 20px;"><b>Paid by</b></td>
                                        <td style="padding-left: 180px; padding-bottom: 20px;"><?php echo $_SESSION['person_2'];?></td>
                                    </tr>
                                    <tr>
                                        <td><b>Paid On</b></td>
                                        <td style="padding-left: 170px;"><?php echo $_SESSION['date2'];?></td>
                                    </tr>
                                </tbody>
                            </table>
                      </div>
                               <center>
                                   <h3 style="color:darkcyan;">Show bill</h3>
                               </center>
                  </div>
                      </div>
                  </div>
                ...
                <div style="float:right; margin-top: 50px;" class="col-xs-5 col-xs-offset-7">
                    <div class="panel panel-default">
                        ...
                        <input type="file" class="form-control" name="upload_bill" id="upload_bill" placeholder="No file chosen">
                              ...
                              <a>  <button style="border-color: #2E8B57; color: #2E8B57;" class="btn btn-default btn-block">Add</button></a>
                            </form>
                        </div>
                    </div>
                </div>
